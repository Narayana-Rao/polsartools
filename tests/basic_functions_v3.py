...
if __name__ == "__main__":
    ...
    process_chunks_parallel(input_filepaths, output_filepaths, window_size=20,write_flag=True,block_size=(512, 512), max_workers=None, processing_func=process_dprvi, num_outputs=2
                                 )
