...
def dopdp(infolder, outname=None, window_size=1,write_flag=True,max_workers=None):
    ...
    process_chunks_parallel(input_filepaths, list(output_filepaths), window_size=window_size, write_flag=write_flag,processing_func=process_chunk_dopdp,block_size=(512, 512), max_workers=max_workers,  num_outputs=1)

def process_chunk_dopdp(chunks, window_size,input_filepaths,*args):
