...
@time_it
def cprvi(infolder, outname=None, chi_in=45, window_size=1,write_flag=True,max_workers=None):
    input_filepaths = [
...
def process_chunk_cprvi(chunks, window_size,input_filepaths,chi_in):
